...
import { buildLoadedMapFromSource, type LoadedMap } from "../../data/loadMap";
import {
  deleteMap,
  fetchCatalog,
  fetchMap,
...
import { clearCachedMap, getCachedCatalog, getCachedMap, setCachedCatalog, setCachedMap } from "../../data/mapCache";
