/**
 * Concept view model — the single source of truth for "what a concept shows".
 *
 ...
 *
 * Companion to content.ts (raw field extractors) and the concept components.
...
function buildRelations(node: GraphNode, map: AtlasMap): ConceptRelations {
...
export function buildConceptView(node: GraphNode, map: AtlasMap, mapId: MapId): ConceptView {
...
export function useConceptView(node: GraphNode, map: AtlasMap, mapId: MapId): ConceptView {
